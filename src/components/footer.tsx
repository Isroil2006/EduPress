...
export default function Footer() {
    return (
        <div className=" bg-[#F5F5F5]">
            <div className="myContainer text-[#555555] flex flex-col justify-end">
                <div className="flex items-start justify-between py-[50px]">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            >
                                <g clip-path="url(#clip0_1_1431)">
                                    ...
                                    />
                                    <path
                                        d="M39.3008 1.36426V26.5026C33.611 26.8852 27.9833 27.46 22.5289 29.4474C22.5857 29.2571 22.6214 29.0921 22.6834 28.9387C23.1878 27.6744 23.7102 26.4175 24.1978 25.1469C24.3386 24.7791 24.5446 24.5721 24.9177 24.4344C27.4914 23.4896 30.1703 23.0272 32.8712 22.6604C33.5059 22.5742 34.1417 22.4586 34.7797 22.4366C35.2904 22.4198 35.3966 22.2148 35.3955 21.7429C35.3797 16.833 35.3923 11.9241 35.3766 7.01409C35.3745 6.50438 35.4985 6.10398 35.8243 5.70672C36.8626 4.43509 37.8663 3.13298 38.8857 1.84454C38.9939 1.70686 39.1137 1.5797 39.3008 1.36426Z"
                                        fill="#FF782D"
                                    />
                                    <path
                                        d="M17.4918 16.8643C17.4834 17.7503 17.9268 18.3682 18.6972 18.7928C18.8832 18.8948 19.1165 19.1365 19.1176 19.3151C19.1417 22.7811 19.1354 26.2471 19.1323 29.7131C19.1323 29.7625 19.1028 29.8129 19.0429 30C18.5816 28.8587 18.1633 27.834 17.7534 26.8062C16.2832 23.129 14.8098 19.4517 13.3584 15.7661C13.2533 15.4971 13.2334 15.1387 13.3111 14.8613C13.7736 13.225 14.2633 11.5971 14.7751 9.97546C14.8991 9.58451 14.8287 9.37223 14.4945 9.13051C11.8461 7.21465 8.8846 5.99347 5.76122 5.11173C5.4617 5.02766 5.14747 4.81957 4.9499 4.57891C3.90842 3.30938 2.90163 2.01147 1.88432 0.721977C1.73824 0.537012 1.60162 0.344691 1.4072 0.0830078C6.42331 0.360455 10.914 1.90743 15.0305 4.56104C16.2748 5.36291 17.4623 6.25305 18.6825 7.09275C19.0041 7.31449 19.1512 7.56882 19.1459 7.98604C19.1228 10.089 19.1281 12.1929 19.1428 14.2969C19.1459 14.6584 19.0671 14.8571 18.6993 15.0168C17.9174 15.3563 17.5002 16.0047 17.4918 16.8643Z"
                                        fill="#FF782D"
                                    />
                                    <path
                            ...
                            <h1 className="text-[28px] font-bold text-black font-exo">EduPress</h1>
                        </div>
                        <p className="w-[340px] leading-[150%] font-jost">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua.
                        </p>
                    </div>
                    <div className="flex flex-col gap-4">
                        <h1 className="text-[28px] font-bold text-black font-exo">GET HELP</h1>
                        <a href="#" className="hover:text-[#FF782D] font-jost">
                            Contact Us
                        </a>
                        <a href="#" className="hover:text-[#FF782D] font-jost">
                            Latest Articles
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-[28px] font-bold text-black font-exo">PROGRAMS</h1>
                        <a href="#" className="hover:text-[#FF782D] font-jost">
                            Art & Design
                        </a>
                        <a href="#" className="hover:text-[#FF782D] font-jost">
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-[28px] font-bold text-black font-exo">CONTACT US</h1>
                        <p className="font-jost">
                            Address: 2321 New Design Str, Lorem Ipsum10 <br /> Hudson Yards, USA
                        </p>
                        ...
                        <div className="flex items-center gap-6">
                            <a href="#" className="hover:text-[#FF782D]">
                                <svg
                                    width="9"
                                    height="17"
                                    viewBox="0 0 9 17"
                ...
                <p className="border-t border-t-[#EAEAEA] pt-8 text-center pb-8 font-jost">
