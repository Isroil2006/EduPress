...
export default function BlogTop() {
  ...
  return (
    <div className="myContainer flex items-start justify-between py-4">
      {/* left  */}
      <div className="w-[990px] flex flex-col gap-[30px]">
        <h1 className="font-exo font-[600] text-[36px]">
          Best LearnPress WordPress Theme Collection for 2023
        </h1>
        <div className="flex items-center gap-[24px]">
          <div className="flex items-center gap-1">
            <img
              src="/blog-images/blog-single-img/blog-single-top-1.svg"
              alt=""
            />
        ...
        <div className="flex w-full items-center gap-[20px] pt-[15px]">
          <span className="font-jost font-[400] text-[18px] text-[#000]">
            Tags:
          </span>
          <ul className="w-full flex flex-wrap gap-[10px]">
            <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">
              Free couses
            </button>
            <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">
              Marketing
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-[5px]">
            <a
              className="hover:text-[#FF782D] text-[#555555] p-[5px] duration-300"
              href=""
            >
              <svg
                width="9"
        ...
        <div className="flex w-full gap-4">
          <div className="w-[600px] flex items-center gap-6 border border-[#9D9D9D] rounded-[10px] p-8 ">
            ...
            <div className="flex flex-col gap-3">
              <span className="font-jost font-[400] text-[18px] text-[#9D9D9D]">
                Prev Articles
              </span>
              <h2 className="font-exo font-[600] text-[20px]">
                Best LearnPress WordPress Theme Collection for 2023
              </h2>
            </div>
          </div>
