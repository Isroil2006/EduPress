...
export default function BlogTop() {
    ...
    return (
        <div className="myContainer flex flex-col">
            {/* left  */}
            <div className="w-[990px] flex flex-col gap-[30px]">
                <h1 className="font-exo font-[600] text-[36px]">Best LearnPress WordPress Theme Collection for 2023</h1>
                <div className="flex items-center gap-[24px]">
                    <div className="flex items-center gap-1">
                        <img src="/blog-images/blog-single-img/blog-single-top-1.svg" alt="" />
                        <span className="font-jost font-[400] text-[16px] text-[#555555]">Determined-poitras</span>
                    </div>

                    <div className="flex items-center gap-1">
                        <img src="/blog-images/blog-single-img/blog-single-top-1.svg" alt="" />
                        <span className="font-jost font-[400] text-[16px] text-[#555555]">Jan 24, 22023</span>
                    </div>

                    <div className="flex items-center gap-1">
                        <img src="/blog-images/blog-single-img/blog-single-top-1.svg" alt="" />
                        <span className="font-jost font-[400] text-[16px] text-[#555555]">20 Comments</span>
                    </div>
                </div>
                <img src={img} alt="" className="w-full h-[600px] object-cover rounded-[24px]" />
                <div className="flex flex-col gap-[30px]">
                    <span className="font-jost font-[400] text-[18px] text-[#555555]">
                    ...
                    <span className="font-jost font-[400] text-[18px] text-[#555555]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras facilisis faucibus odio arcu duis dui, adipiscing facilisis. Urna, donec turpis egestas volutpat. Quisque nec non amet quis. Varius tellus justo odio parturient mauris curabitur lorem in. Pulvinar sit ultrices mi ut eleifend luctus ut. Id sed faucibus bibendum augue id cras purus</span>
                </div>
                <div className="flex w-full items-center gap-[20px] pt-[15px]">
                    <span className="font-jost font-[400] text-[18px] text-[#000]">Tags:</span>
                    <ul className="w-full flex flex-wrap gap-[10px]">
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">Free couses</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">Marketing</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">Idea</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">LMS</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">LearnPress</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px] cursor-pointer hover:bg-gray-200 active:scale-98">Instructor</button>
                    </ul>
                </div>
                <div className="flex items-center gap-5">
                    <span className="font-jost font-[400] text-[18px] text-[#555555]">Share:</span>
                ...
                <div className="flex w-full">
                    <div className="w-full flex items-center gap-6">
                        <button className="bg-[#F5F5F5] p-[20px] rounded-[8px] cursor-pointer">
                            <svg width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.41 1.41L6 0L0 6L6 12L7.41 10.59L2.83 6L7.41 1.41Z" fill="#9D9D9D" />
                            </svg>
                        </button>
                        <div className="flex flex-col gap-3">
                            <span className="font-jost font-[400] text-[18px] text-[#9D9D9D]">Prev Articles</span>
                            <h2 className="font-exo font-[600] text-[20px]">Best LearnPress WordPress Theme Collection for 2023</h2>
                        </div>
                    </div>
                </div>
            </div>
