...
export default function AllBlog() {
    ...
    function Card({ img, id }: CardProps) {
        return (
            <div onClick={() => navigate(`/blog/${id}`, { state: { img } })} className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full" : "flex-col"}`}>
                <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-cover bg-no-repeat" style={{ backgroundImage: `url(${img})` }}></div>

                <div className="flex flex-col gap-4 p-[20px] ">
                    <h3 className="duration-300 font-exo font-[600] text-[22px] m-0 hover:text-[#FF782D]">Best LearnPress WordPress Theme Collection for 2023</h3>
                    ...
                    <div className="flex items-center w-full justify-between">
                        <div className="flex items-center gap-2">
                            <span className="font-jost font-[400] text-[16px] text-[#555555]">Looking for an amazing & well-functional LearnPress WordPress Theme?...</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="myContainer flex gap-[30px] py-[60px]">
            ...
            <div className="w-[990px]">
                ...
                <div className="flex flex-col gap-[30px] mt-[40px]">
                    <div className={`flex gap-[30px] items-center transition-all duration-400  justify-between  ${activeView === "list" ? "flex-col" : "flex-row"}`}>
                        <Card id={1} img="/blog-images/blog-img1.png" />
                        <Card id={2} img="/blog-images/blog-img2.png" />
                    </div>

                    <div className={`flex gap-[30px] items-center transition-all duration-400  justify-between  ${activeView === "list" ? "flex-col" : "flex-row"}`}>
                        <Card id={3} img="/blog-images/blog-img3.png" />
                        <Card id={4} img="/blog-images/blog-img4.png" />
                    </div>

                    <div className={`flex gap-[30px] items-center transition-all duration-400  justify-between  ${activeView === "list" ? "flex-col" : "flex-row"}`}>
                        <Card id={5} img="/blog-images/blog-img5.png" />
                        <Card id={6} img="/blog-images/blog-img6.png" />
                    </div>
                </div>
            </div>
            ...
            <div className="flex w-[270px] flex-col gap-[20px]">
                <div className="flex w-full flex-col gap-[20px] pt-[15px]">
                    <span className="font-exo font-[600] text-[20px] text-[#000]">Category</span>
                ...
                <div className="flex w-full flex-col gap-[20px] pt-[15px]">
                    <span className="font-exo font-[600] text-[20px] text-[#000]">Recent posts</span>
                    <ul className="w-full flex flex-col gap-[10px]">
                        <div className="flex align-items-center gap-4">
                            <img src="/blog-images/blog-img7.png" alt="" />
                            <p className="hover:text-[#FF782D] duration-300 font-medium">Best LearnPress WordPress Theme Collection for 2023</p>
                        </div>
                        <div className="flex align-items-center gap-4">
                            <img src="/blog-images/blog-img8.png" alt="" />
                            <p className="hover:text-[#FF782D] duration-300 font-medium">Best LearnPress WordPress Theme Collection for 2023</p>
                        </div>
                        <div className="flex align-items-center gap-4">
                            <img src="/blog-images/blog-img9.png" alt="" />
                            <p className="hover:text-[#FF782D] duration-300 font-medium">Best LearnPress WordPress Theme Collection for 2023</p>
                        </div>
                    </ul>
                </div>
                ...
                <div className="flex w-full flex-col gap-[20px] pt-[15px]">
                    <span className="font-exo font-[600] text-[20px] text-[#000]">Tags</span>
                    <ul className="w-full flex flex-wrap gap-[10px]">
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">Free couses</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">Marketing</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">Idea</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">LMS</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">LearnPress</button>
                        <button className="border border-[#EAEAEA] py-2 px-5 w-auto rounded-[10px]">Instructor</button>
                    </ul>
                </div>
            </div>
        </div>
