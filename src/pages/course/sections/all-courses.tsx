        ...
        <div className="myContainer flex gap-[30px] py-[60px]">
            ...
            <div className="w-[990px]">
                    ...
                    <div className="flex items gap-5 items-center">
                        ...
                        <div className="flex items-center  border-b-[1px] border-[#000] gap-2">
                            <input
                                type="text"
                                placeholder="Search"
                                className="text-[#9D9D9D] font-jost font-[400] text-[18px] outline-0"
                            />
                            <svg
                                width="20"
                                height="20"
                        ...
                        <div className="flex items-center gap-5">
                            <button className="cursor-pointer" onClick={() => setActiveView("grid")}>
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={`duration-200 ease-in-out ${activeView === "grid" ? "text-orange-500" : "text-black"}`}
                                >
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M0 0V6.66667H6.66667V0H0ZM0 8.33333V15H6.66667V8.33333H0ZM8.33333 0V6.66667H15V0H8.33333ZM8.33333 8.33333V15H15V8.33333H8.33333Z"
                                        fill="currentColor"
                                    />
                                </svg>
                            </button>
                            ...
                            <button className="cursor-pointer" onClick={() => setActiveView("list")}>
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={`duration-200 ease-in-out ${activeView === "list" ? "text-orange-500" : "text-black"}`}
                                >
                                    <path
                                        d="M0 6.25H2.29167V3.95833H0V6.25ZM0 10.2083H2.29167V7.91667H0V10.2083ZM0 2.29167H2.29167V0H0V2.29167ZM3.95833 6.25H15.4167V3.95833H3.95833V6.25ZM3.95833 10.2083H15.4167V7.91667H3.95833V10.2083ZM3.95833 0V2.29167H15.4167V0H3.95833Z"
                                        fill="currentColor"
                                    />
                                </svg>
                            </button>
                ...
                <div className="flex flex-col gap-[30px] mt-[40px]">
                    <div
                        className={`flex gap-[30px] items-center  justify-between  ${activeView === "list" ? "flex-col" : "flex-row"}`}
                    >
                        {/* card  */}
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-1.png')] bg-cover bg-no-repeat">
                            ...
                            <div className="flex flex-col gap-4 p-[20px] ">
                                ...
                                <div className="flex items-center gap-[24px]">
                                    ...
                                    <div
                                        className={`flex items-center gap-[10px] ${activeView === "list" ? "" : "hidden"}`}
                                    >
                                        <svg
                                            width="16"
                                            height="16"
                                ...
                                <span
                                    className={`w-full h-[1px] bg-[#EAEAEA] ${activeView === "list" ? "inline-block mt-auto" : ""}`}
                                ></span>
                        ...
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-2.png')] bg-cover bg-no-repeat">
                                <span className="px-3 py-2 font-jost font-[500] text-[16px] bg-black rounded-[8px] text-white">
                                    Photography
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-3.png')] bg-cover bg-no-repeat">
                                <span className="px-3 py-2 font-jost font-[500] text-[16px] bg-black rounded-[8px] text-white">
                                    Photography
                                </span>
                            </div>
                        ...
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-4.png')] bg-cover bg-no-repeat">
                                <span className="px-3 py-2 font-jost font-[500] text-[16px] bg-black rounded-[8px] text-white">
                                    Photography
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-5.png')] bg-cover bg-no-repeat">
                                <span className="px-3 py-2 font-jost font-[500] text-[16px] bg-black rounded-[8px] text-white">
                                    Photography
                                </span>
                            </div>
                        ...
                        <div
                            className={`flex w-[480px] overflow-hidden border-[1px] border-[#EAEAEA] rounded-[24px] transition-all duration-400 hover:-translate-y-[16px] cursor-pointer hover:shadow-lg ${activeView === "list" ? "flex-row w-full " : "flex-col"}`}
                        >
                            <div className="p-[20px] w-[480px] h-[250px] flex items-start bg-[url('/home-images/courses-images/courses-6.png')] bg-cover bg-no-repeat">
                                <span className="px-3 py-2 font-jost font-[500] text-[16px] bg-black rounded-[8px] text-white">
                                    Photography
                                </span>
                            </div>
            ...
            <div className="flex w-[270px] flex-col gap-[20px]">
                <div className="flex w-full flex-col gap-[20px] pt-[15px]">
                    ...
                    <ul className="w-full flex flex-col gap-[10px]">
                        ...
                        <li className="flex items-center gap-[6px]">
                            <input className=" w-[15px] h-[15px] cursor-pointer" type="checkbox" />
                            <span className=" w-full  font-jost font-[400] text-[18px] text-[#555555]">
                                Single family home
                            </span>
                            <span className="  text-end font-jost font-[400] text-[18px] text-[#555555]">15</span>
                        </li>
